...
using [Rails Templates](http://guides.rubyonrails.org/rails_application_templates.html) with Materialize instead of bootstrap.
...
rails new \
  -T --database postgresql \
  -m https://raw.githubusercontent.com/karine03/rails-templates/master/devise.rb \
  CHANGE_THIS_TO_YOUR_RAILS_APP_NAME
```
